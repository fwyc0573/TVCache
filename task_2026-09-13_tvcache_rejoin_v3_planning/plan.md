...
This task is in planning only. The packets below describe later work; none is marked as executed here. The source of truth is `draft-plan/TVCache_ReJoin_Codex_Plan_v3_ZH.md` at pinned commit `43cf9d6a779eb5149e0fae50b9a3a891dcbaed6f`.
